...
CCGradientWavesView.swift: 倒挂涟漪氛围层（MTKView 真管线 30fps 透明混合；speech 0…1 能量经渲染器攻快 0.5/衰慢 0.1 包络平滑；配色原版级饱和 horizon=primary/wave=混白 55%/crest=白，**禁混背景淡化——那是隐身元凶**；Reduce Motion 暂停；管线装配失败 DEBUG 报错不静默）
