...
CCModifiers.swift: 系统效果兼容边界（iOS 26 Liquid Glass / 18.6–25 微拟物同形降级：ccGlassEffect/softGlassStyle；SoftGlassShape 含 .custom(AnyShape) 任意轮廓）+ appleCard/ccGroupCard/shimmer
